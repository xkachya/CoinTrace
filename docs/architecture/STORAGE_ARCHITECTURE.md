...
**Статус:** ✅ Accepted v1.4.2 — [PRE-1]..[PRE-8] вирішено; Variant A (2×200KB logs), ID validation, mutex scope, GPIO0 boot, Soft Reset semantics, coredump filename, open-once pattern  
**Версія:** 1.4.2  
**Дата:** 2026-03-13  
