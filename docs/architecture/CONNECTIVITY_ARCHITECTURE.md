...
**Статус:** � Частково реалізовано — A-1 WiFiManager ✅ hw-verified (2026-03-17)  
**Версія:** 1.4.0  
**Дата:** 2026-03-13  
...
| WiFi 802.11 b/g/n | TCP/IP | ✅ A-1 hw-verified | AP `CoinTrace-XXXX`/`cointrace`/192.168.4.1; STA+mDNS; promptSTA() via 'W' |
