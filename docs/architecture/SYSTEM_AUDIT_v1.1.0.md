...
**Версія аудиту:** 1.2.0  
**Дата:** 13 березня 2026 (оновлено: хвиля 4 — 14 березня 2026 — LA-2: виправлено skin depth §3.2 (значення були при 10 MHz, не 1 MHz); ADR-RESP-001 додано; TC1/TC2 verify додано)  
...
**Знайдено 24 знахідки (v1.1.0); v1.2.0 закрило 6: **0 CRITICAL · 5 HIGH · 7 MEDIUM · 4 LOW · 2 INFO** відкритих
